...
##Homework 5 of ADM within the MSc in Data Science @ La Sapienza University
---
...
*Step 1:	we compute subgraph of input category assuming for every in-edges a weight of 1.<\br>
*Step 2: Now if we take into account that: the in-edges coming from the previous category have as weights the score of the node that sends the edge.
...
*Step 3: And again we need to store weights of edges of the graph that we got in step 2. And then organize a cycle to add categories respecting to their position in ranking vector.
